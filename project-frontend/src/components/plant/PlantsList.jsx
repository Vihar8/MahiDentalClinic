import {
  ...
  const PlantsList = () => {
    ...
    const tableHeading = [
        ...
        { id: "validPlantDate", header: "Plant Start Date" },
        { id: "expiredDate", header: "Plant End Date" },
        { id: "capacityOffer", header: "Capacity To Offer" },
        { id: "subscriberAmount", header: "Subscriber Amount(Wp)" },
        { id: "tariffAmount", header: "Tariff Amount per(Wp)" },
