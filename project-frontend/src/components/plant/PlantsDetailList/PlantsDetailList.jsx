...
const PlantsList = () => {
  ...
  useEffect(() => {
    ...
    const mockData = [
      ...
      },
      {
        ...
        description:
          "A hydroelectric plant utilizing river flow for energy production.",
        Address: "123 Maple, Street Springfield, IL",
        state: "Washington",
        city: "Seattle",
        country: "USA",
      ...
      },
      {
        ...
        description:
          "A plant converting organic waste into sustainable energy.",
        Address: "123 Maple, Street Springfield, IL",
        state: "Maharashtra",
        city: "Mumbai",
        country: "India",
      ...
      },
      {
        ...
        description:
          "A tidal power plant generating electricity from ocean waves.",
        address: "123 Maple, Street Springfield, IL",
        state: "Queensland",
        city: "Brisbane",
        country: "Australia",
  ...
  const tableHeading = [
    ...
    { id: "capacityOffer", header: "Capacity Offer" },
