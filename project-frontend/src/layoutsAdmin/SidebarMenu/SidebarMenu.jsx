...
const SidebarMenu = ({ menuCollapse }) => {
    ...
    const adminMenu = [
        ...
        },
        {
          menusName: "Plant",
          path: "plant",
          icons: <img src={plants} className={`${classes.iconSizee}`} />,
        },
        {
            menusName: "Pay Bill",
            path: "paybill",
            icons: <img src={cmsIcon} className={`${classes.iconSize}`} />,
        },
        {
            menusName: "Wallet",
            path: "wallet",
            icons: <img src={reportIcon} className={`${classes.iconSize}`} />,
        },
        {
          menusName: "Subscription Verify",
          path: "subscription-verify",
          icons: <img src={subverify} className={`${classes.iconSizee}`} />,
      },
    ];
